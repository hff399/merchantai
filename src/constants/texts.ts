...
Рекомендуем прочитать гайд, чтобы получить максимум от сервиса 👇`,
  ...
  // Punchy /start message
  START: `🎨 <b>MerchantAI</b>

Карточки для WB/Ozon за 30 секунд.
Фото → AI → Готовая инфографика.
...
`,
  ...
  GENERATION_SUCCESS: `✅ <b>Карточка готова!</b>

Измените промпт или выберите действие 👇`,
...
• Или вернитесь в главное меню`,
  ...
  IMAGE_CARD_NO_CREDITS: `🚫 <b>Лимит исчерпан!</b>

Для генерации карточки нужно <b>4 токена</b>.

💰 Пополните баланс и продолжайте создавать продающие карточки без ожидания.

<i>🔥 Скидка до 25% на большие пакеты</i>`,
...
• И т.д.`,
  ...
  EDIT_PROMPT: `✏️ Опишите изменения:
Например: "больше золота", "темнее фон"`,
...
• Или вернитесь в главное меню`,
  ...
  IMAGE_EDIT_NO_CREDITS: `🚫 <b>Лимит исчерпан!</b>

Для редактирования нужно <b>2 токена</b>.

💰 Пополните баланс — редактирование в 2 раза дешевле генерации!

<i>🔥 Скидка до 25% на большие пакеты</i>`,

  // Need credits popup
  NEED_CREDITS_SHORT: `💳 <b>Нужны токены</b>
...
export const CALLBACKS = {
  ...
  CAROUSEL_SELECT_REF: 'carousel_select_ref_', // + variant index (0, 1, 2...)
  CAROUSEL_USE_CURRENT: 'carousel_use_current', // Use current (last) variant as reference
} as const;